from sqlalchemy import Column, Integer, String, DateTime, create_engine, Enum, ForeignKey, Float, Boolean
...
class Prediction(Base):
    ...
    id = Column(String, primary_key=True)
    media_id = Column(String, ForeignKey("media.id"))  # Which file
