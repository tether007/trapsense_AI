            ...
            <div className="p-6 overflow-y-auto max-h-[60vh]">
              ...
              <div className="mb-6">
                <p className="text-gray-700 mb-4">
                  Found <span className="font-bold text-green-600">{nonBlankImages.length}</span> non-blank images with animal detections.
                </p>
              ...
              {downloading && (
                <div className="mb-6 animate-fade-in">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-green-500 to-blue-500 animate-pulse" style={{width: '100%'}} />
                  </div>
